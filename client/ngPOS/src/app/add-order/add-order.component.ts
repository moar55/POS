...
export class AddOrderComponent implements OnInit {
  ...
  getManfList() {
    this.orderServ.getManfs()
      .subscribe(
      res => {
        console.log(`res from getManfList is ${res['data']}`); // da bydy [object Object],[object Object],[object Object],[object Object]
        console.log(`res from getManfList is `, res['data']); //  da bydy array of objects sa7 gdn !
        this.manufacturers = res['data']; // <-- da msh sh3'al leh ?? da by5aleh [object Object],[object Object] !!
